...
import ru.narod.nod.fifteen.databinding.ActivityPrivacyPolicyBinding
...
Developer built the 'Fifteen' app as an Ad Supported app. This SERVICE is provided by the Developer at no cost and is intended for use as is.
...
For a better experience, while using our Service, I may require you to provide us with certain personally identifiable information, including but not limited to technical data of a device . The information that I request will be retained on your device and is not collected by me in any way.
